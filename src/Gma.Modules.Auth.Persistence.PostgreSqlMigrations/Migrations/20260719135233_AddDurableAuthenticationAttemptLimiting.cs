        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetHash = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_authentication_failure_attempts_ScopeId_Purpose_TargetHash_~",
                schema: "auth",
                table: "authentication_failure_attempts",
