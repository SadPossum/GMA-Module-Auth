...
This repository owns the optional GMA Auth module: password and multi-provider identities, safe account linking, email verification, enumeration-safe password recovery, authentication assurance and password step-up, session security, JWT integration, admin member management, provider-split persistence, and auth integration events.
